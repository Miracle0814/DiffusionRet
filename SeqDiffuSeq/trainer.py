...
class Trainer:
    ...
    def _load_and_sync_parameters(self):
        ...
        resume_checkpoint = self.checkpoint_path + '/model640000.pt'
    ...
    def _load_ema_parameters(self, rate):
        ...
        main_checkpoint = self.checkpoint_path + '/ema_0.9999_640000.pt'
        ema_checkpoint = find_ema_checkpoint(main_checkpoint, self.resume_step, rate)
        print("ema_chcek",ema_checkpoint)
        if ema_checkpoint:
            if dist.get_rank() == 0:
    ...
    def _load_optimizer_state(self):
        ...
        main_checkpoint = self.checkpoint_path
